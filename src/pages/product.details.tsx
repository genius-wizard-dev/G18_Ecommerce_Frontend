...
const ProductDetails = () => {
  ...
  const getInitial = () => {
    if (shopInfo?.fullName && shopInfo.fullName.length > 0) {
      return shopInfo.fullName.charAt(0).toUpperCase();
    }
    return "U";
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <Link
            ...
            className="flex items-center space-x-3 p-3 rounded-lg bg-orange-50 border-l-4 border-orange-500 hover:bg-orange-100 transition-colors duration-200"
          >
            <div className="w-12 h-12 rounded-full bg-orange-500 flex items-center justify-center text-white text-2xl font-bold border-3 border-white shadow-md">
              {getInitial()}
            </div>
