...
const categories = ["Tất cả", "Thời trang nam", "Thời trang nữ", "Giày dép", "Phụ kiện"];
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            {isLoading ? (
                <div className="flex justify-center items-center h-64">
                    <div className="text-lg font-semibold text-gray-700 animate-pulse">Đang tải sản phẩm...</div>
                </div>
                    ...
                    {filteredProducts.map((product) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                ...
                                <p className="text-red-600 font-bold text-lg mb-2">{formatPrice(product.price)}</p>
