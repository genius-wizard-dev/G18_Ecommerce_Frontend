export const ENDPOINTS = {
    ...
    ADDRESS: {
        ...
        SET_DEFAULT: (profileId: string, addressId: string) => `/profile/address/set-default/${profileId}/${addressId}`,
        UPDATE_TYPE: (addressId: string, type: string) => `/profile/address/update-type/${addressId}?type=${type}`,
